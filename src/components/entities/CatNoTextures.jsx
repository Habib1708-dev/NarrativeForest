...
export default forwardRef(function CatNoTextures(_, ref) {
  // Load cat GLB without textures (resides under /public)
  const { scene, animations } = useGLTF("/models/cat/bicolor_cat_no_textures.glb");
      ...
      if (o.isMesh) {
        ...
        const recordColor = (mat) => {
          ...
          if (!originalColors.current.has(mat.uuid)) {
            ...
            // Make material matte (non-metallic, high roughness)
            if (clonedMat.isMeshStandardMaterial || clonedMat.isMeshPhysicalMaterial) {
              clonedMat.metalness = 0.0;
              clonedMat.roughness = 1.0;
            }
...
useGLTF.preload("/models/cat/bicolor_cat_no_textures.glb");
