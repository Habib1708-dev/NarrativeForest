...
export default forwardRef(function CatKTX2(_, ref) {
  ...
  const { scene, animations } = useGLTF("/models/cat/bicolor_cat_ktx2.glb");
      ...
      if (o.isMesh) {
        ...
        const recordColor = (mat) => {
          ...
          if (!originalColors.current.has(mat.uuid)) {
            ...
            // Make material matte (non-metallic, high roughness) - same as CatNoTextures
            if (
              clonedMat.isMeshStandardMaterial ||
              clonedMat.isMeshPhysicalMaterial
            ) {
...
useGLTF.preload("/models/cat/bicolor_cat_ktx2.glb");
