#!/usr/bin/env node
/**
 * Script to compress Radio tower.glb with KTX2/WebP texture compression
 * Creates Radio tower_ktx2.glb in the same directory
 */
...
const outputFile = join(projectRoot, 'public/models/radioTower/Radio tower_ktx2.glb');

console.log('📡 Compressing Radio Tower model with KTX2/WebP...\n');
