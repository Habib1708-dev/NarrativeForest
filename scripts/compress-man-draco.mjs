#!/usr/bin/env node
/**
 * Script to compress man.glb with Draco geometry compression
 * Creates man_draco.glb in the same directory
 */
...
const outputFile = join(projectRoot, 'public/models/man/man_draco.glb');

console.log('👤 Compressing Man model with Draco...\n');
