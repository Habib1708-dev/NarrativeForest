#!/usr/bin/env node
/**
 * Script to compress man.glb with KTX2/WebP texture compression
 * Creates man_ktx2.glb in the same directory
 */
...
const outputFile = join(projectRoot, 'public/models/man/man_ktx2.glb');

console.log('👤 Compressing Man model...\n');
